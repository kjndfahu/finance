...
export const PaymentHistory:React.FC<Props> = ({className})=>{
            ...
            <div className="flex flex-col gap-3">
                <div className="flex flex-row items-center border-b-[1px] py-3 border-[#b0b0b0] justify-between">
                    <div className="flex flex-row gap-3">
                        <div className="bg-[#f5f5f5] w-[85px] rounded-full"></div>
                        <div className="flex flex-col gap-1">
                            <h1 className="text-[19px]">{t('deposit-creation')}</h1>
                            <h3 className="text-[#b0b0b0]">{t('open-deposit')}</h3>
