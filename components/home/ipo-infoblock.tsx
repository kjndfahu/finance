    ...
    return (
        <div
            ...
            <div className="flex flex-col gap-5">
                <h2 className="font-semibold text-black text-[50px]  leading-[43px]">Earnings on IPOs<br/> are available to everyone</h2>
                <p className="text-[20px] text-black font-thin">You don't need to be a professional investor<br/> to make money on the public market</p>
                <div
