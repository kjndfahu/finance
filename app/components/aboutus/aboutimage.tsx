...
export const AboutImage:React.FC<Props> = ({className}) => {
    return(
        <div className="flex flex-col w-full h-[600px] rounded-[30px] bg-[#004b44]">
            <div className="flex flex-col justify-center mx-[100px] w-[570px] gap-5">
                ...
                <div className="flex items-center bg-[#15B0DB] w-[190px] rounded-[10px] py-1 px-7 font-semibold justify-center text-white">Get a free account</div>
            </div>
        </div>
    )
}